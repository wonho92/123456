...
st.title("카테고리를 선택해 질문을 열어보세요")

import streamlit as st

# ✅ 커서 올릴 때 파란색으로 바꾸는 CSS 주입
st.markdown("""
<style>
    /* expander 제목 텍스트 hover 시 */
    .streamlit-expanderHeader:hover {
        color: #007bff !important;  /* 텍스트 색상 (청색) */
    }

    /* expander 전체 박스 hover 시 */
    .streamlit-expander:hover {
        border: 1px solid #007bff !important;  /* 테두리 색상 (청색) */
...
qa_data = [
    {"category": "회사 일반", "question": "회사의 주요 사업 분야는 무엇인가요?", "answer": "저희 회사는 보안 솔루션 개발 및 시스템 구축, 그리고 모바일 커머스 서비스를 주력으로 하고 있습니다."},
    {"category": "회사 일반", "question": "조직 규모는 어떻게 되나요?", "answer": "현재 약 250명 정도의 임직원이 재직 중이며, R&D와 기술영업 인력이 절반 이상을 차지하고 있습니다."},
    {"category": "회사 일반", "question": "회사의 비전이나 중장기 전략이 있다면 알려주세요.", "answer": "저희는 '기술 기반의 지속가능한 보안 생태계 구축'을 목표로 하고 있으며, 향후 글로벌 보안 시장 진출도 계획 중입니다."},
    {"category": "회사 일반", "question": "최근 1~2년간 주요 성과가 있다면 무엇인가요?", "answer": "작년에는 국내 대형 공공기관 대상 보안 솔루션 수주에 성공했고, T사와의 파트너십을 통해 연 매출 400억 원을 돌파했습니다."},
    {"category": "회사 일반", "question": "회사의 근무지는 본사 외에도 다른 지역에 있나요?", "answer": "현재는 서울 본사 한 곳에서만 운영 중이며, 재택/하이브리드 근무는 부서별로 다르게 적용됩니다."},
    {"category": "조직문화", "question": "사내 커뮤니케이션 방식은 어떤 편인가요?", "answer": "협업툴로 슬랙과 노션을 활용하고 있으며, 수평적인 분위기에서 의견 교환이 활발합니다."},
    {"category": "조직문화", "question": "상사나 동료와의 관계는 어떤가요?", "answer": "대부분 팀장급 이상도 닉네임이나 영어이름을 사용하며, 자유롭게 피드백을 주고받는 문화입니다."},
    {"category": "조직문화", "question": "사내 교육은 어떻게 운영되나요?", "answer": "입사 초기에는 온보딩 교육, 분기별로는 직무 역량 향상 교육과 외부 위탁교육 등이 제공됩니다."},
...
selected_category = st.selectbox("카테고리를 선택하세요", sorted(set([qa["category"] for qa in qa_data])))

filtered_qas = [qa for qa in qa_data if qa["category"] == selected_category]
