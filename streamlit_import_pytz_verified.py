...
qa_data = [
    # 회사 소개 Q&A 20개
    {"category": "회사제도안내 - 보상", "question": "평가 제도는 어떻게 운영되나요?", "answer": "분기별 OKR 기반 성과 평가와 직무/역량 평가가 병행되며, 직속 상사와의 면담도 포함됩니다."},
    {"category": "회사제도안내 - 보상", "question": "승진은 어떤 기준으로 이뤄지나요?", "answer": "근속연수보다는 직무성과와 리더십 역량을 종합 반영하며, 승진 심사는 연 1회 실시됩니다."},
    {"category": "회사제도안내 - 보상", "question": "개인의 목표설정이나 OKR은 자유롭게 설정하나요?", "answer": "부서 목표를 기준으로 자율적으로 설정하되, 팀장과의 사전 협의가 필요합니다."},
    {"category": "회사제도안내 - 보상", "question": "연봉협상은 어떤 방식으로 진행되나요?", "answer": "연 1회 성과평가와 회사 전체 실적을 기반으로 조정되며, PI나 PS 형태의 인센티브도 있습니다."},
    {"category": "회사제도안내 - 보상", "question": "식대나 교통비는 지원되나요?", "answer": "중식은 구내식당 이용이 가능하며, 외부 이용 시 월 10만 원 한도로 식대가 지원됩니다. 교통비는 별도 지원되지 않습니다."},
    {"category": "회사제도안내 - 보상", "question": "자기계발비나 교육비는 지원되나요?", "answer": "자격증 취득비와 외부교육비를 연간 50만 원까지 지원하고 있으며, 신청 절차는 간단합니다."},
    {"category": "회사제도안내 - 보상", "question": "건강검진이나 의료 관련 복지는 어떻게 되나요?", "answer": "매년 전 임직원 대상 건강검진이 제공되며, 간단한 심리상담 및 헬스케어 앱 연계 서비스도 지원됩니다."}
]
